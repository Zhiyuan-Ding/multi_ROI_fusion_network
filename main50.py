# -*- coding: utf-8 -*-
"""
Created on Mon Mar  1 12:08:06 2021
...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  1 11:27:58 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sat Feb 27 20:49:54 2021
...
def main():
    ...
    args.data=data
    model=resnet3d.ResNet(resnet3d.Bottleneck, [3, 4, 6, 3],resnet3d.get_inplanes(),
                         n_input_channels=1,
                         conv1_t_size=27,
                         conv1_t_size2=27,
                         conv1_t_size3=20,
...
def main_worker(local_rank,nprocs, args, model):
    ...
    for train_idx, test_idx in kf.split(args.data.Data,args.label):
        ...
        result_path='/home/ding/exp_2/result/result_Hippocampus_resnet50_'+str(n_split)+'time.npy'
