# -*- coding: utf-8 -*-
"""
Created on Fri Mar 19 14:41:12 2021
...
class Main_Net(nn.Module):
    def __init__(self,branch1,branch2):
        ...
        self.branch1_weight=nn.Linear(in_features=128, out_features=128, bias=False)
        self.branch2_weight=nn.Linear(in_features=128, out_features=128, bias=False)
        self.Flatten=nn.Flatten()
        self.fcn1=nn.Sequential(
                                nn.Linear(in_features=128*128, out_features=2, bias=True)
                                )
...
#        self.fcn2=nn.Sequential(nn.Linear(in_features=64, out_features=2, bias=True))
    def forward(self,x1,x2):
        ...
        feature1_weighted=self.branch1_weight(feature1)
        feature2_weighted=self.branch2_weight(feature2)
        
        size1=feature1_weighted.shape[1]
        size2=feature2_weighted.shape[1]
        
        feature1_expand=feature_expand(feature1_weighted, size2)
        feature2_expand=feature_expand(feature2_weighted, size1)
        feature2_expand=torch.transpose(feature2_expand, 1,2)
        
        feature_synthesize=feature1_expand+feature2_expand
        feature_synthesize=self.Flatten(feature_synthesize)
        feature_synthesize=feature_synthesize+feature_kron(feature1,feature2)
        output=self.fcn1(feature_synthesize)
...
#    os.environ['CUDA_VISIBLE_DEVICES']='4,5'
    ...
    args.save_path1='/home/ding/exp_2/result/result_Hippocampus_L_synthesize_exp_2_'
    args.save_path2='/home/ding/exp_2/result/result_Hippocampus_R_synthesize_exp_2_'
    
    args.orginal_params_save_path1='/home/ding/exp_2/data/Hippocampus_L_original_synthesize_exp_2_'
    args.orginal_params_save_path2='/home/ding/exp_2/data/Hippocampus_R_original_synthesize_exp_2_'
    
    args.params_save_path1='/home/ding/exp_2/data/Hippocampus_L_synthesize_exp_2_'
    args.params_save_path2='/home/ding/exp_2/data/Hippocampus_R_synthesize_exp_2_'
    
    args.model1=model1
    args.model2=model2
    
    args.save_path_main='/home/ding/exp_2/result/result_kronecker_synthesize_exp_2_'
...
#        torch.save(current_model.state_dict(), params_save_path)
        ...
        current_model=Main_Net(model_channel1,model_channel2)
