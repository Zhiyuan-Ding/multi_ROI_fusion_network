# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 23:18:19 2021
...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar  4 10:04:33 2021
...
def main():
    ...
    data_path='/home/ding/exp_2/data/ParaHippocampus_L_data.npy'
...
def main_worker(local_rank,nprocs, args, model):
    ...
    for train_idx, test_idx in kf.split(args.data.Data,args.label):
        ...
        result_path='/home/ding/exp_2/result/result_'+args.arch+'ParaHippocampus_L'+str(n_split)+'time.npy'
