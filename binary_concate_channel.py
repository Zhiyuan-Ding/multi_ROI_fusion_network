# -*- coding: utf-8 -*-
"""
Created on Sun Mar 21 11:06:44 2021
...
class Main_Net(nn.Module):
    def __init__(self,branch1,branch2,common_model):
...
#    model1=basic_model(model1,args.rank)
    model2=resnet3d.ResNet(resnet3d.BasicBlock, [1, 1, 1, 1],resnet3d.get_inplanes(),
                     ...
                     shortcut_type='B',
                     n_classes=2)
    model_common=resnet3d.ResNet(resnet3d.BasicBlock, [1, 1, 1, 1],resnet3d.get_inplanes(),
                     n_input_channels=1,
                     conv1_t_size=27,
                     conv1_t_size2=28,
                     conv1_t_size3=21,
...
#    model2=basic_model(model2,args.rank)
    args.save_path1='/home/ding/exp_2/result/result_Hippocampus_L_conv_concate_'
    args.save_path2='/home/ding/exp_2/result/result_Hippocampus_R_conv_concate_'
    
    args.orginal_params_save_path1='/home/ding/exp_2/data/Hippocampus_L_original_conv_concate_'
    args.orginal_params_save_path2='/home/ding/exp_2/data/Hippocampus_R_original_conv_concate_'
    
    args.params_save_path1='/home/ding/exp_2/data/Hippocampus_L_kronecker_conv_concate_'
    args.params_save_path2='/home/ding/exp_2/data/Hippocampus_R_kronecker_conv_concate_'
    
    args.model1=model1
    args.model2=model2
    args.common_model=model_common
    args.save_path_main='/home/ding/exp_2/result/result_kronecker_product_conv_concate_'
...
#        torch.save(current_model.state_dict(), params_save_path)
        ...
        model_channel1= nn.Sequential(*list(current_model1.children())[:-3])

        set_gradient(current_model2)
        model_channel2= nn.Sequential(*list(current_model2.children())[:-3])
        
        common_model=args.common_model
        
        common_model = nn.Sequential(*list(common_model.children())[-3:-1],
                             nn.Flatten(),
                             nn.Linear(512,2,bias=True))
#        print(common_model[0][0].conv1.in_channels)
#        common_model[0][0].conv1.in_channels=512
        common_model[0][0].conv1=nn.Conv3d(512,512,kernel_size=(3,3,3),stride=(2,2,2), padding=(1,1,1),bias=False)
        common_model[0][0].downsample[0]=nn.Conv3d(512, 512, kernel_size=(1, 1, 1), stride=(2, 2, 2), bias=False)
#        print(common_model)        
        current_model=Main_Net(model_channel1,model_channel2,common_model)
