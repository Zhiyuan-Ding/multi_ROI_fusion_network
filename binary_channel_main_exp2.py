# -*- coding: utf-8 -*-
"""
Created on Thu Mar 11 09:49:25 2021
...
# -*- coding: utf-8 -*-
"""
Created on Sat Mar  6 18:57:19 2021
...
#    os.environ['CUDA_VISIBLE_DEVICES']='0,1,2,3,4'
    ...
    args.save_path1='/home/ding/exp_2/result/result_Hippocampus_L_exp2'
    args.save_path2='/home/ding/exp_2/result/result_Hippocampus_R_exp2'
    
    args.orginal_params_save_path1='/home/ding/exp_2/data/Hippocampus_L_original_'
    args.orginal_params_save_path2='/home/ding/exp_2/data/Hippocampus_R_original_'
    
    args.params_save_path1='/home/ding/exp_2/data/Hippocampus_L_'
    args.params_save_path2='/home/ding/exp_2/data/Hippocampus_R_'
    
    args.model1=model1
    args.model2=model2
    
    args.save_path_main='/home/ding/exp_2/result/result_two_branch_exp'
...
#        params_save_path=args.params_save_path2+str(n_split)+'exp_params.pth'
#        torch.save(current_model.state_dict(), params_save_path)
        
#        params_save_path1=args.params_save_path1+str(n_split)+'exp_params.pth'
#        trained_model1=args.model1
#        trained_model1.load_state_dict(torch.load(params_save_path1))
        set_gradient(current_model1,n_layers=33)
        model_channel1= nn.Sequential(*list(current_model1.children())[:-1])
        
#        params_save_path2=args.params_save_path2+str(n_split)+'exp_params.pth'
#        trained_model2=args.model2
#        trained_model2.load_state_dict(torch.load(params_save_path2))
        set_gradient(current_model2,n_layers=33)
...
#        current_model1=model_channel1
#        current_model1.cuda(local_rank)
#        model_para1 = torch.nn.parallel.DistributedDataParallel(current_model1, device_ids=[local_rank])
#        
#        current_model2=model_channel2
#        current_model2.cuda(local_rank)
#        model_para2 = torch.nn.parallel.DistributedDataParallel(current_model2, device_ids=[local_rank])
