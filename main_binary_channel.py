...
def main_worker(local_rank,nprocs, args):
    ...
    for train_idx, test_idx in kf.split(args.data1,args.label):
        ...
        train_loader,test_loader,train_sampler,test_sampler= dataloader_preprocessing_binary_channel(train_idx,test_idx,args)     
...
def dataloader_preprocessing_binary_channel(train_idx,test_idx,args):
        total_data=data_synthesize(args.data1,args.data2)
