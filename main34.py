# -*- coding: utf-8 -*-
"""
Created on Sun Feb 28 21:52:04 2021
...
def main():
    ...
    args.data=data
    model=resnet3d.ResNet(resnet3d.BasicBlock, [3, 4, 6, 3],resnet3d.get_inplanes(),
                         n_input_channels=1,
                         conv1_t_size=27,
                         conv1_t_size2=27,
                         conv1_t_size3=20,
...
def main_worker(local_rank,nprocs, args, model):
    ...
    for train_idx, test_idx in kf.split(args.data.Data,args.label):
        ...
        result_path='/home/ding/exp_2/result/result_resnet34_Hippocampus'+str(n_split)+'time.npy'
