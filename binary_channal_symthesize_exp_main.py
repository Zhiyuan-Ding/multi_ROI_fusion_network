...
class Main_Net(nn.Module):
    def __init__(self,branch1,branch2):
        ...
        self.fcn1=nn.Sequential(nn.Flatten(),
...
#        self.fcn2=nn.Sequential(nn.Linear(in_features=64, out_features=2, bias=True))
    def forward(self,x1,x2):
        ...
        feature1=self.branch1_weight(feature1)
        feature2=self.branch2_weight(feature2)
        
        size1=feature1.shape[1]
        size2=feature2.shape[1]
        
        feature1_expand=feature_expand(feature1, size2)
        feature2_expand=feature_expand(feature2, size1)
...
#    os.environ['CUDA_VISIBLE_DEVICES']='4,5'
    ...
    args.save_path1='/home/ding/exp_2/result/result_Hippocampus_L_synthesize_exp_1_'
    args.save_path2='/home/ding/exp_2/result/result_Hippocampus_R_synthesize_exp_1_'
    
    args.orginal_params_save_path1='/home/ding/exp_2/data/Hippocampus_L_original_synthesize_exp_1_'
    args.orginal_params_save_path2='/home/ding/exp_2/data/Hippocampus_R_original_synthesize_exp_1_'
    
    args.params_save_path1='/home/ding/exp_2/data/Hippocampus_L_synthesize_exp_1_'
    args.params_save_path2='/home/ding/exp_2/data/Hippocampus_R_synthesize_exp_1_'
    
    args.model1=model1
    args.model2=model2
    
    args.save_path_main='/home/ding/exp_2/result/result_kronecker_synthesize_exp_1_'
