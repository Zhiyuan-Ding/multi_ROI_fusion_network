...
#    os.environ['CUDA_VISIBLE_DEVICES']='4,5'
    ...
    data_path1='/home_old/ding/exp_2/data/Hippocampus_LAD_NC.npy'
    data_path2='/home_old/ding/exp_2/data/Hippocampus_R_data.npy'
    data_path3='/home_old/ding/exp_2/data/ParaHippocampus_L_data.npy'
    ...
    model3=resnet3d.ResNet(resnet3d.BasicBlock, [1, 1, 1, 1],resnet3d.get_inplanes(),
                     ...
                     shortcut_type='B',
                     n_classes=2)    
    args.save_path1='/home_old/ding/exp_2/result/result_Hippocampus_L_kronecker_tri_exp1_'
    args.save_path2='/home_old/ding/exp_2/result/result_Hippocampus_R_kronecker_tri_exp1_'
    args.save_path3='/home_old/ding/exp_2/result/result_ParaHippocampus_L_kronecker_tri_exp1_'
    
    
    args.orginal_params_save_path1='/home_old/ding/exp_2/data/Hippocampus_L_original_tri_exp1_'
    args.orginal_params_save_path2='/home_old/ding/exp_2/data/Hippocampus_R_original_tri_exp1_'
    args.orginal_params_save_path3='/home_old/ding/exp_2/data/ParaHippocampus_L_tri_exp1_'
    
    
    args.params_save_path1='/home_old/ding/exp_2/data/Hippocampus_L_kronecker_tri_exp1_'
    args.params_save_path2='/home_old/ding/exp_2/data/Hippocampus_R_kronecker_tri_exp1_'
    args.params_save_path3='/home_old/ding/exp_2/data/ParaHippocampus_L_kronecker_tri_exp1_'
    
    args.model1=model1
    args.model2=model2
    args.model3=model3
    
    args.save_path_main='/home_old/ding/exp_2/result/result_kronecker_product_kronecker_tri_exp1_'
