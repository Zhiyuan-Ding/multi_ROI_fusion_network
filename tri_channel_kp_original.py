# -*- coding: utf-8 -*-
"""
Created on Sun Mar 28 17:46:12 2021
...
# -*- coding: utf-8 -*-
"""
Created on Thu Mar 18 10:24:32 2021
...
class Main_Net(nn.Module):
    def __init__(self,branch1,branch2,branch3):
        ...
        self.fcn1=nn.Sequential(nn.Linear(in_features=128*128*128, out_features=2, bias=True)
                                )
...
#    os.environ['CUDA_VISIBLE_DEVICES']='4,5'
    ...
    model1=resnet3d.ResNet(resnet3d.BasicBlock, [1, 1, 1, 1],resnet3d.get_inplanes(),
                     ...
                     shortcut_type='B',
                     n_classes=2)
    model1=basic_model(model1,args.rank)
    model2=resnet3d.ResNet(resnet3d.BasicBlock, [1, 1, 1, 1],resnet3d.get_inplanes(),
                     ...
                     shortcut_type='B',
                     n_classes=2)
    model2=basic_model(model2,args.rank)
    ...
    model3=resnet3d.ResNet(resnet3d.BasicBlock, [1, 1, 1, 1],resnet3d.get_inplanes(),
                 ...
                 shortcut_type='B',
                 n_classes=2) 
    model3=basic_model(model3,args.rank)
    
    args.save_path1='/home/ding/exp_2/result/result_Hippocampus_L_kp_tri3_'
    args.save_path2='/home/ding/exp_2/result/result_Hippocampus_R_kp_tri3_'
    args.save_path3='/home/ding/exp_2/result/result_ParaHippocampus_L_kp_tri3_'
    
    args.orginal_params_save_path1='/home/ding/exp_2/data/Hippocampus_L_original_kp_tri3_'
    args.orginal_params_save_path2='/home/ding/exp_2/data/Hippocampus_R_original_kp_tri3_'
    args.orginal_params_save_path3='/home/ding/exp_2/data/ParaHippocampus_L_original_kp_tri3_'
    
    args.params_save_path1='/home/ding/exp_2/data/Hippocampus_L_kronecker_kp_tri3_'
    args.params_save_path2='/home/ding/exp_2/data/Hippocampus_R_kronecker_kp_tri3_'
    args.params_save_path3='/home/ding/exp_2/data/ParaHippocampus_L_kronecker_kp_tri3_'
    ...
    args.save_path_main='/home/ding/exp_2/result/result_kp_tri3_'
...
#        torch.save(current_model.state_dict(), params_save_path)
        ...
        current_model=Main_Net(model_channel1,model_channel2,model_channel3)
